...
const categoryGuideMap: Record<string, string[]> = {
  landmarks: ['first-time-visiting-cancun', 'cancun-3-day-itinerary', 'best-walking-tours-cancun-2026'],
  'river-cruises': ['bus-tour-vs-boat-tour-cancun', 'cancun-tours-for-couples', 'cancun-3-day-itinerary'],
  'day-trips': ['best-day-trips-from-cancun', 'first-time-visiting-cancun', 'cancun-3-day-itinerary'],
  'food-tours': ['cancun-food-tours', 'free-things-to-do-in-cancun-2026'],
  'family-fun': ['best-cancun-tours-for-kids', 'cancun-rainy-day-activities', 'free-things-to-do-in-cancun-2026'],
  'walking-tours': ['best-walking-tours-cancun-2026', 'first-time-visiting-cancun', 'free-things-to-do-in-cancun-2026'],
  'museums-exhibitions': ['cancun-rainy-day-activities', 'first-time-visiting-cancun', 'best-cancun-tours-for-kids'],
  'evening-experiences': ['cancun-tours-for-couples', 'best-walking-tours-cancun-2026', 'best-evening-tours-cancun-2026'],
};
...
export default async function TourPage({ params }: { params: Params }) {
  ...
  // "Or book instead" — destination's top converter (Cancun for BLT)
  const topConverter = TOP_CONVERTER_BY_DESTINATION.cancun;
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 pb-28 lg:pb-12">
        ...
        {tour.categories.length > 0 && (
          <section className="mt-16">
            <SectionHeader title="Browse more Cancun tours" />
            <div className="flex flex-wrap gap-2">
        ...
        {(() => {
          ...
          return (
            <section className="mt-16 rounded-card-lg bg-surface-muted p-6 sm:p-8">
              <h2 className="text-xl font-semibold text-on-surface mb-4">More Cancun guides</h2>
